...
- `access_code`: códigos temporários usados no fluxo de segundo fator e outros fluxos futuros;
...
5. Em caso de falha, as tentativas sao contabilizadas e a conta pode ser bloqueada.
